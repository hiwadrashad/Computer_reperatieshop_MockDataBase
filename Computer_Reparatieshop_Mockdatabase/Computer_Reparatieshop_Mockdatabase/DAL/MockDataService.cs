...
namespace Computer_Reparatieshop_Mockdatabase.DAL
{
    ...
    public class MockDataServiceReparationInProgress : IDataService<ModelReparatie>
    {
        ...
        public MockDataServiceReparationInProgress()
        {
            ...
            {
                    new ModelReparatie { Id = Guid.NewGuid().ToString(), StartDatum = new DateTime(2020,9,25),EindDatum = new DateTime(2020,12,25), status = "in afwachting", PrijsArbeid = 150, PrijsProducten = 1200, Totaal = 1350, Omschrijving = "Collide lekt", onderdelen =  new PartModel  { id = Guid.NewGuid().ToString(), Name ="Collide", numberofpartsavailable = 12, qualityofpart = "Medium" } , Klant = new ClientModel {  Id = Guid.NewGuid().ToString(), AdressNummer = 56, GebruikersNaam = "fox132", Naam = "Donatello", Plaats = "Amersfoort", PostCode = "5645KM", Straatnaam = "Amsterdamseestraatweg", telefoonnummer = "06-3656456", Wachtwoord ="kangaroo6897" }, Reparateur = new WerknemerModel { Id = Guid.NewGuid().ToString(), AdressNummer = 76, Naam = "antilope345", password ="turtle3234", Plaats = "Groningen", PostCode = "5657PG", Straatnaam = "Bernhoflaan", telefoonnummer = "030-26672672", username = "Moose123", rol = RolesWerknemer.Roles.coördinator } },
                        new ModelReparatie { Id = Guid.NewGuid().ToString(), StartDatum = new DateTime(2020,10,25),EindDatum = new DateTime(2020,11,25), status = "in afwachting", PrijsArbeid = 200, PrijsProducten = 1200, Totaal = 1450, Omschrijving = "vooruit moet vervangen worden", onderdelen = new PartModel  { id = Guid.NewGuid().ToString(), Name ="vooruit", numberofpartsavailable = 14, qualityofpart = "laag" } , Klant = new ClientModel {  Id = Guid.NewGuid().ToString(), AdressNummer = 56, GebruikersNaam = "fox132", Naam = "Donatello", Plaats = "Amersfoort", PostCode = "5645KM", Straatnaam = "Amsterdamseestraatweg", telefoonnummer = "06-3656456", Wachtwoord ="kangaroo6897" }, Reparateur = new WerknemerModel { Id = Guid.NewGuid().ToString(), AdressNummer = 76, Naam = "antilope345", password ="turtle3234", Plaats = "Groningen", PostCode = "5657PG", Straatnaam = "Bernhoflaan", telefoonnummer = "030-26672672", username = "Moose123", rol = RolesWerknemer.Roles.coördinator } },
                            new ModelReparatie { Id = Guid.NewGuid().ToString(), StartDatum = new DateTime(2020,11,25),EindDatum = new DateTime(2020,10,25), status = "in afwachting", PrijsArbeid = 40, PrijsProducten = 1100, Totaal = 1140, Omschrijving = "uitlaat vervangen", onderdelen = new PartModel  { id = Guid.NewGuid().ToString(), Name ="uitlaat", numberofpartsavailable = 22, qualityofpart = "hoog" } , Klant = new ClientModel {  Id = Guid.NewGuid().ToString(), AdressNummer = 56, GebruikersNaam = "fox132", Naam = "Donatello", Plaats = "Amersfoort", PostCode = "5645KM", Straatnaam = "Amsterdamseestraatweg", telefoonnummer = "06-3656456", Wachtwoord ="kangaroo6897" }, Reparateur = new WerknemerModel { Id = Guid.NewGuid().ToString(), AdressNummer = 76, Naam = "antilope345", password ="turtle3234", Plaats = "Groningen", PostCode = "5657PG", Straatnaam = "Bernhoflaan", telefoonnummer = "030-26672672", username = "Moose123", rol = RolesWerknemer.Roles.coördinator } },
                               new ModelReparatie { Id = Guid.NewGuid().ToString(), StartDatum = new DateTime(2020,12,25),EindDatum = new DateTime(2020,9,25), status ="in afwachting", PrijsArbeid = 150, PrijsProducten = 2200, Totaal = 2350, Omschrijving = "airbag vervangen", onderdelen = new PartModel  { id = Guid.NewGuid().ToString(), Name ="airbag", numberofpartsavailable = 32, qualityofpart = "hoog" } , Klant = new ClientModel {  Id = Guid.NewGuid().ToString(), AdressNummer = 56, GebruikersNaam = "fox132", Naam = "Donatello", Plaats = "Amersfoort", PostCode = "5645KM", Straatnaam = "Amsterdamseestraatweg", telefoonnummer = "06-3656456", Wachtwoord ="kangaroo6897" }, Reparateur = new WerknemerModel { Id = Guid.NewGuid().ToString(), AdressNummer = 76, Naam = "antilope345", password ="turtle3234", Plaats = "Groningen", PostCode = "5657PG", Straatnaam = "Bernhoflaan", telefoonnummer = "030-26672672", username = "Moose123", rol = RolesWerknemer.Roles.coördinator } },
               new ModelReparatie { Id = Guid.NewGuid().ToString(), StartDatum = new DateTime(2020,8,25),EindDatum = new DateTime(2020,8,25), status = "in afwachting", PrijsArbeid = 180, PrijsProducten = 100, Totaal = 280, Omschrijving = "Collide lekt", onderdelen = new PartModel  { id = Guid.NewGuid().ToString(), Name ="Collide", numberofpartsavailable = 42, qualityofpart = "Medium" } , Klant = new ClientModel {  Id = Guid.NewGuid().ToString(), AdressNummer = 56, GebruikersNaam = "fox132", Naam = "Donatello", Plaats = "Amersfoort", PostCode = "5645KM", Straatnaam = "Amsterdamseestraatweg", telefoonnummer = "06-3656456", Wachtwoord ="kangaroo6897" }, Reparateur = new WerknemerModel { Id = Guid.NewGuid().ToString(), AdressNummer = 76, Naam = "antilope345", password ="turtle3234", Plaats = "Groningen", PostCode = "5657PG", Straatnaam = "Bernhoflaan", telefoonnummer = "030-26672672", username = "Moose123", rol = RolesWerknemer.Roles.coördinator } }
        ...
        {
            return items.Where(x => x.status == "klaar").Count();
        }

        public int CountInBehandeling()
        {
            return items.Where(x => x.status == "in behandeling" ).Count();
        }

        public int CountWachtenOpOnderdelen()
        {
            return items.Where(x => x.status == "wachten op onderdelen").Count();
        }
        public int CountInAfwachting()
        {
            return items.Where(x => x.status ==  "in afwachting").Count();
        }
